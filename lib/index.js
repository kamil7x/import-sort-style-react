...
function default_1(styleApi, file) {
    ...
    const isReactModule = (imported) => { console.log(imported); return Boolean(imported.moduleName.match(/^(react|prop-types|redux)/)); };
    ...
    return [
        ...
        { match: isInstalledModule(path_1.dirname(file)), sort: moduleName(naturally), sortNamedMembers: alias(unicode) },
        { separator: true },
        //
